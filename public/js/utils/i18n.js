...
export const translations = {
  nl: {
    ...
    'tab-join': '→ Join Room',
    'tab-present': '📺 Presenteer',
    'present-hint': 'Toon een bestaande room op een groot scherm. Je doet zelf niet mee — deelnemen doe je op je eigen apparaat.',
    'btn-present': '📺 Open presenter-scherm',
    'label-name': 'Jouw naam',
    'label-room-name': 'Room naam',
    'label-where-vote': 'Waar doe je zelf mee?',
    'mode-elsewhere': '📱 Op mijn telefoon of ander apparaat',
    'mode-elsewhere-sub': 'Dit scherm wordt het presenter-scherm.',
    'mode-here': '💻 Op dit apparaat',
    'mode-here-sub': 'Je komt meteen in de room te zitten.',
    'label-deck': 'Kaartdek',
    ...
    'presenter-join-title': 'Doe mee',
    'presenter-options-sub': 'Instellingen van dit scherm.',
    'presenter-collapse-side': 'Inklappen',
    'presenter-expand-side': 'Uitklappen',
    'presenter-empty': 'Nog niemand in de room. Scan de QR-code om mee te doen.',
    'presenter-closed': 'Deze room bestaat niet meer.',
    ...
    // Same two buttons without the emoji: the presenter screen carries the
    // glyph in its own element so it can drop the label in the collapsed rail.
    'sm-reveal-label': 'Reveal',
    'sm-reset-label': 'Nieuwe ronde',
    ...
    'toast-enter-room-name': 'Voer een room naam in',
  ...
  en: {
    ...
    'tab-join': '→ Join Room',
    'tab-present': '📺 Present',
    'present-hint': 'Show an existing room on a big screen. You are not taking part — join from your own device for that.',
    'btn-present': '📺 Open presenter screen',
    'label-name': 'Your name',
    'label-room-name': 'Room name',
    'label-where-vote': 'Where will you be voting?',
    'mode-elsewhere': '📱 On my phone or another device',
    'mode-elsewhere-sub': 'This screen becomes the presenter screen.',
    'mode-here': '💻 On this device',
    'mode-here-sub': 'You are seated in the room right away.',
    ...
    'presenter-join-title': 'Join in',
    'presenter-options-sub': 'Settings for this screen.',
    'presenter-collapse-side': 'Collapse',
    'presenter-expand-side': 'Expand',
    'presenter-empty': 'Nobody has joined yet. Scan the QR code to take part.',
    'presenter-closed': 'This room no longer exists.',
    ...
    'toast-enter-room-name': 'Please enter a room name',
